...
//        if(stripos($obj->distname,"vlcc")==TRUE){
	...
	if(trim($Exp_date[0])=='0000-00-00' && $obj->master_dealer_id==8){
        ...
        if(trim($obj->vat)<=0){
         ...
         if($obj->master_dealer_id==3 || $obj->master_dealer_id==4 || $obj->master_dealer_id==5 || $obj->master_dealer_id==41 || $obj->master_dealer_id==49 || $obj->master_dealer_id==24 || $obj->master_dealer_id==8 || $obj->master_dealer_id==21){
            $amt = $obj->amt;
        }else{
