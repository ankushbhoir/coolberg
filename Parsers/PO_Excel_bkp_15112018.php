...
//        if(stripos($obj->distname,"vlcc")==TRUE){
        if(preg_match('/(vlcc|VLCC|Vlcc)/',$obj->distname)){
        ...
        if($obj->master_dealer_id==3 || $obj->master_dealer_id==4 || $obj->master_dealer_id==5 || $obj->master_dealer_id==41){
            $amt = $obj->amt;
        }else{
       ...
       $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, $rowCount, $obj->vendorcode);
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14, $rowCount, $State);
