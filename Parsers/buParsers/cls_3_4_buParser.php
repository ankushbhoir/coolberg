...
class cls_3_4_buParser{
    ...
    public function process($file_text){
        ...
        $response=getAddr($lines,$start_line_no,$end_line_no,$file_text);
        return $response; 
 ...
 function getAddr($lines,$start_line_no,$end_line_no1,$file_text){
...
//                $cnt=0;
        ...
        //            }
                     ...
                     $found= chkDBaddr($shipping_address, $db);
...
//                     }            
                        ...
                        $db->closeConnection();
                        print "<br>CALL NEXT 3_5 BU PARSER <br>";
                        $clsname = "cls_3_5_buParser";
        ...
        //fn db 0/1
function chkDBaddr($shipping_address, $db){
