...
//                    $end_line_no = $start_line_no +1; //for fetching DC code only
//                }
            }
        }
        $cnt=0;
        ...
        print "<br><br> SHIPPING sadsadsad: $shipping_address <br>";
        ...
        if(isset($sobj)){
            $db->closeConnection();
             ...
             if($inimasterdealerid=='4'){
                $inimasterdealerid=3;
             }
          print "<br>ssdd Dealer ID : $inimasterdealerid </br>";
            return $shipping_address."::".$inimasterdealerid;
        }else{
           $db->closeConnection();
//            print "<br>CALL NEXT 1 BU PARSER <br>";
//            $clsname = "cls_3_1_buParser";
