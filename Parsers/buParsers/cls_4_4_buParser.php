...
class cls_4_4_buParser{
    ...
    public function process($file_text){
        ...
        $response=getAddress($lines,$start_line_no,$end_line_no,$file_text);
        return $response; 
 ...
 function getAddress($lines,$start_line_no,$end_line_no1,$file_text){
...
//                $cnt=0;
        ...
        //            }
                     ...
                     $found= chkDB($shipping_address, $db);
...
//                     }
                        ...
                        $db->closeConnection();
                        print "<br>CALL NEXT 4_5 BU PARSER <br>";
                        $clsname = "cls_4_5_buParser";
        ...
        //fn db 0/1
function chkDB($shipping_address, $db){
