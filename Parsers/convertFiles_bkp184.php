            ...
            if(finfo_file($finfo, $source.$file)=='text/html') {
                ...
                if(trim($file)!="" && trim($file)!="." && trim($file) != ".."){    
                   ...
                   if(file_exists($source."".$file)){
                       ...
                       //print "<br> FILE txt: $file_txt <br>";
                        ...
                        moveFiles($source,$file_htm,$file_txt,$type);
                    }
                }
                ...
                if(trim($file)!="" && trim($file)!="." && trim($file) != ".."){  
                    ...
                    if(file_exists($source."".$file)){
                        ...
                        moveFiles($source,$file_pdf,$file_text,$type);
                    }
                }
            }else {
...
function moveFiles($readpath,$file_org,$file_text,$type){
...
function insertpostatus($db,$pdfname,$master_dealer_id,$iniid,$response,$file){ 
    ...
    //        store line count of each PO in database in it_process_status table (add new cloumn)
