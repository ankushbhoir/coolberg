...
require_once "lib/email/EmailHelper.php";
 ...
 $subject = "Unrecognized Chain Found";
        $body = "<br>Hi<br>";
        $body .= "<p>Chain Identifier is not found for following PO </p>";
        $body .= '

  <p>Attachment of  Missing Chain details</p>';
...
//.date('Y-m-d').
 echo $get_file_name="select id,po_filenames,fullpath from it_po_details where status=0 and datetime LIKE '2021-08-27%' and sent=0";
