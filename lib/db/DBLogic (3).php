...
function checkShippingDetails($shiptoparty,$site){
    $this->db = new DBConn();
    $query = "select id from it_ship_to_party sh where sh.ship_to_party='$shiptoparty' and sh.site='$site'";
    // echo $query;
    // exit;
    $obj = $this->db->fetchObject($query);
    $this->db->closeConnection();
...
function getshiptopartyDetailsByShippingId($shippingId){
    $this->db = new DBConn();
    $query = "select s.id, s.ship_to_party, m.displayname, s.site,s.classification, s.emaildomain from it_ship_to_party s, it_master_dealers m where s.master_dealer_id = m.id and s.id=$shippingId";
   // echo $query;
   $obj = $this->db->fetchObject($query);
    $this->db->closeConnection();
    if(isset($obj)){
...
function updateShippingDetails($shippingid,$shiptoparty,$site,$classification,$emaildomain,$old_shiptoparty,$old_site,$old_classification,$old_emaildomain) {
    $this->db = new DBConn();
    ...
    if($classification != $old_classification){
        $addQuery .= ", classification = '$classification'";
    }

    $query = "update it_ship_to_party set emaildomain='$emaildomain' $addQuery where id = $shippingid";
    // print_r($query);
    // exit;
    $id = $this->db->execUpdate($query);
...
function getVendorMasterDetails($vendorId){
    $this->db = new DBConn();
    $query = "select  v.id,m.displayname,v.vendor_number,v.plant from it_vendor_plant_mapping v,it_master_dealers m where v.master_dealer_id=m.id and v.id=$vendorId";
   // echo $query;
   // exit;
   $obj = $this->db->fetchObject($query);
    $this->db->closeConnection();
 ...
 function checkVendorMasterDetails($vendorno,$plant){
  $this->db = new DBConn();
    $query = "select id from it_vendor_plant_mapping  sh where vendor_number='$vendorno' and plant='$plant'";
    // echo $query;
    // exit;
    $obj = $this->db->fetchObject($query);
    $this->db->closeConnection();
   ...
   function updateVendorMasterDetails($vendorid,$vendorno,$plant,$old_vendorno,$old_plant){
    $this->db = new DBConn();
    ...
    $query = "update it_vendor_plant_mapping set $addQuery where id = $vendorid";
    // print_r($query);
    // exit;
    $id = $this->db->execUpdate($query);
  ...
  function getSkuMasterDetails($sku_id){
    $this->db = new DBConn();
    $query = "select  id,ean,sku,classification from it_ean_sku_mapping where id='$sku_id'";
   $obj = $this->db->fetchObject($query);
    $this->db->closeConnection();
    if(isset($obj)){
        return $obj;
  ...
  function checkSkuMasterDetails($sku,$ean){
      $this->db = new DBConn();
    $query = "select id from it_ean_sku_mapping s where s.sku='$sku' and s.ean='$ean'";
    // echo $query;
    // exit;
    $obj = $this->db->fetchObject($query);
    $this->db->closeConnection();
  ...
  function updateSkuMasterDetails($skuid,$sku,$ean,$classification,$old_sku,$old_ean,$old_classification){
    $this->db = new DBConn();
    ...
    $query = "update it_ean_sku_mapping set classification='$classification' $addQuery where id = $skuid";
    // print_r($query);
    // exit;
    $id = $this->db->execUpdate($query);
