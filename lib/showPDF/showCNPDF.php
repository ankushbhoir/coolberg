...
class showCNPDF {
      ...
      function addTableHeader($invoice_no,$invoice_dt,$dealer_name,$dealer_addr,$dealer_gstno,$dealer_panno,$dist_name,$dist_addr,$dist_gstno,$dist_panno,$type_text) {        
        return '<tr>
                <th style="align=center;width:102%;height:30px;font-size:20px;" colspan="2"><b>Credit Note</b></th>
                </tr>
                <tr>
                <th style="align=left;width:50%;height:30px;font-size:20px;"><b>CN NO: '.$invoice_no.'</b></th>
