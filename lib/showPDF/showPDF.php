...
//         $roundtotal_tot = round($total_tot,2);
         $roundtotal_tot = round($total_tot,2,PHP_ROUND_HALF_UP);
         $roundtotal_tot = sprintf("%.2f",$roundtotal_tot);
         
         $round_total_qty = round($total_qty,4,PHP_ROUND_HALF_UP);
         $round_total_qty = sprintf("%.4f",$round_total_qty);
         
         $round_all_total_val = round($all_total_val,2,PHP_ROUND_HALF_UP);
         $round_all_total_val = sprintf("%.2f",$round_all_total_val);
         
         $round_total_sgst_amt = round($total_sgst_amt,2,PHP_ROUND_HALF_UP);
         $round_total_sgst_amt = sprintf("%.2f",$round_total_sgst_amt);
         
         $round_total_cgst_amt= round($total_cgst_amt,2,PHP_ROUND_HALF_UP);
         $round_total_cgst_amt = sprintf("%.2f",$round_total_cgst_amt);
        ...
        return '<tr>
                ...
                <th style="align=center;font-size:10px;width:5%;"><b></b></th>
                <th style="align=center;font-size:10px;width:5%;"><b></b>'.$round_total_qty.'</th>
                <th style="align=center;font-size:10px;width:5%;"><b></b></th>
                ...
                <th style="align=right;font-size:10px;width:8%;"><b>'.$this->Currency($round_total_cgst_amt).'</b></th>
                    
                <th style="align=center;font-size:10px;width:5%;"><b></b></th>
                
                <th style="align=right;font-size:10px;width:8%;"><b>'.$this->Currency($round_total_sgst_amt).'</b></th>
                    
                <th style="align=right;font-size:10px;width:7%;"><b></b></th>    
                <th style="align=right;font-size:10px;width:10%;"><b>'.$this->Currency($round_all_total_val).'</b></th>    
                </tr>
                ';
    }
