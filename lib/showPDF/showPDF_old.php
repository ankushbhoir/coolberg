 ...
 *  */    
    ...
    function addColHeader(){
        return '<tr>
                ...
                <th style="align=center;font-size:10px;width:5%;" rowspan="2"><b>Unit Rate (Rs/kg)</b></th>
                ...
                <th style="align=center;font-size:10px;width:5%;" rowspan="2"><b>Base Rate (Rs/kg)</b></th>
                ...
                <th style="align=center;font-size:10px;width:9%;" rowspan="2"><b>Total(Rs)</b></th>
                </tr>
                <tr>
                    <th style="align=center;font-size:10px;width:5%;"><b>Rate%</b></th>
    ...
    function addColHeaderIGST(){
     ...
     function addColFooter($total_qty,$total_tot,$total_disc,$total_taxable_amt,$total_gst_rate,$total_gst_amt){
         ...
         $roundtotal_taxable_amt = round($total_taxable_amt,2);
         $roundtotal_gst_amt = round($total_gst_amt,2);
        return '<tr>
                ...
                <th style="align=center;font-size:10px;width:5%;"><b></b></th>
                <th style="align=right;font-size:10px;width:10%;"><b>'.$this->Currency($roundtotal_taxable_amt).'</b></th>
                <th style="align=center;font-size:10px;width:5%;"><b></b></th>
                <th style="align=right;font-size:10px;width:8%;"><b>'.$this->Currency($roundtotal_gst_amt).'</b></th>
                <th style="align=center;font-size:10px;width:5%;"><b></b></th>
                <th style="align=right;font-size:10px;width:8%;"><b>'.$this->Currency($roundtotal_gst_amt).'</b></th>
                <th style="align=right;font-size:10px;width:9%;"><b>'.$this->Currency($roundtotal_tot).'</b></th>    
                </tr>
                ';
    }
    ...
    function addColFooterIGST($total_qty,$total_tot,$total_disc,$total_taxable_amt,$total_gst_rate,$total_igst_amt){
      ...
      function addTransactionDetailsFooter($tot_taxable_value,$net_invoice_value,$tot_sgst_val,$tot_cgst_val,$roundoff,$cashdisc_pct=false,$cashdisc_val=false){
          ...
          $roundtot_taxable_value  = round($tot_taxable_value,2);
          $roundnet_invoice_value  = round($net_invoice_value,2);
          $roundtot_sgst_val = round($tot_sgst_val,2);
          $roundtot_cgst_val = round($tot_cgst_val,2);
