...
//comment by mayur
//H&G 
// Add above inserted id in following resulted rows:

// select * from it_shipping_address where shipping_address = 'NO.6, 7TH MAIN, 80 FEET ROAD, 3RD BLOCK, WARD NO. 68, KORAMANGALA,BEHIND SPENCERÂ¿S, BANGALORE -560';

// SELECT * FROM `it_shipping_address` WHERE shipping_address = 'G FLOOR,NEW NO.59/1,4TH CROSS, CHIKKAMUNIYAPPA REDDY CIRCLE R, WARD NO.89,KACHARAKANAHALLI, BANGALORE PH :';

// SELECT * FROM `it_shipping_address` WHERE shipping_address = 'OLD NO. 71/2, SITE NO. 5,KHATA, NO.723/5/P,MGR COMPLEX, KAIKONDARAHALLI,VARTHUR HOBLI, SARJAPUR MAIN ROAD,';
$uni_array=array (
  'Header' => 
  array (
    'Rows' => 16,
