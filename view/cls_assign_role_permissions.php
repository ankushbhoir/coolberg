...
class cls_assign_role_permissions extends cls_renderer {
...
/*            @import "https://cdn.datatables.net/1.10.15/css/dataTables.bootstrap.min.css";
        ...
        //alert(JSON.stringify(side));
        //alert(JSON.stringify(listRight));
        ...
        function getBySelectedRole(roleid){
        //    var userid = $("#seluser").val();
        //    alert(roleid);
            if(roleid == ""){
                alert("Please select a role first");
            }else{
                var ajaxUrl = "ajax/getPermissionsAssignedToRoles.php?roleid="+roleid;
        //        alert(ajaxUrl);
        ...
        //                alert(data[i]);
                ...
                var ajaxPUrl = "ajax/getNotPermissionsAssignedToRoles.php?roleid="+roleid;
        //        alert(ajaxPUrl);
        ...
        //                 alert(multiplevalues);
                       ...
                       window.location.href="formpost/assignPermissionToRole.php?role_id="+selrole+"&to_enable_permissions="+multiplevalues+"&to_disable_permissions="+multiplevalues2+"&form_id="+form_id;  
        ...
        function createNewRole(){
            ...
            if(new_role == ""){
                ...
                window.location.href="formpost/addNewRole.php?new_role="+new_role+"&form_id="+form_id;  
            }
    ...
    public function pageContent() {
        ...
        $menuitem = "assign_role_permissions";
        ...
        <div class="container-section">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <button type="button" class="btn btn-primary pull-right" onclick="createNewRole();">Create New Role</button>
                    </div>
                </div>
            </div>
            <br>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h2 class="title-bar">Assign Permission to Role</h2>
                            <div class="common-content-block">
                                ...
                                <form  id="userRoleForm" name="userRoleForm" method="" onsubmit="assignPermission(); return false;" > <!--action="formpost/assignFuncsToLocation.php"-->
                                    <input type = "hidden" name="form_id" id="form_id" value="userRoleForm">
                                    <div class="box box-primary"><br>
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                <select id="selrole" name="selrole" class="selectpicker form-control" data-show-subtext="true" data-live-search="true" onchange="getBySelectedRole(this.value);">
                                                    <?php
