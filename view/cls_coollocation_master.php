...
class cls_coollocation_master extends cls_renderer {
    ...
    function extraHeaders() {
        ...
        $(function(){
            var url = "ajax/tb_cool_location.php";
                        oTable = $('#tb_cool_location').dataTable( {
                       "bProcessing": true,
                       "bServerSide": true,
                       "bDestroy": true,
...
//            $chainListObj=$dbl->getChainList();
        if ($formResult->status == 'successEdit') {
            ...
            echo 'alert("Locations updated successfulsy.")';
            echo '</script>';
        }
        ?>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="common-content-block">                     
                            <table id="tb_cool_location" class="table table-striped table-bordered dt-responsive nowrap" width="100%" cellspacing="0">
                                <thead>
                                    <tr>   
                                        <th>ID</th>
                                        <th>LOCATION ID</th>
