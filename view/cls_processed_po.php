...
class cls_processed_po extends cls_renderer{
...
$(function(){      
    var url = "ajax/tb_processed_po.php";
        //             alert(url);
...
function reloadpage(){
        ...
        if(chain_id == null){
            ...
            var url = "ajax/tb_processed_po.php?selDateRange="+dtrng+"&chainId="+chain_id;    
                // alert(url); 
            oTable = $('#tb_po').dataTable({
                                "bProcessing": true,
                                "bServerSide": true,
...
<div class="container-section">
    <div class="row">
                ...
                <div class="col-md-3">
                    <button type="button" class="btn btn-primary pull-right" id="downloadExcel">Download Excel</button>
                </div>
            </div>
            <br/>
    <div class="row">
