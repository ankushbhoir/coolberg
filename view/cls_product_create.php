...
class cls_product_create extends cls_renderer{
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="common-content-block">   
                             <div class="box box-primary"><br>
                                <form role="form" id="createproduct" name="createproduct" enctype="multipart/form-data" method="post" action="formpost/createproduct.php">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <select class="form-control" id="ctgsel" name="ctgsel" onchange="setCtg(this.value);">
                                                ...
                                                <?php foreach($obj_categories as $ctg){ ?>
                                        ...
                                        <div class="form-group">
                                            <input type="text" id="name" name="name" class="form-control" placeholder="Product description" value="<?php echo $this->getFieldValue("name"); ?>">
                                        </div>
                                        <div class="form-group">
