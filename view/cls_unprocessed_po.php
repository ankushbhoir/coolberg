...
class cls_unprocessed_po extends cls_renderer {
    ...
    function extraHeaders() {
        ...
        $(function(){      
            var url = "ajax/tb_unprocessed_po.php";
        //                             alert(url);
            ...
            if(ids.join() != ""){
                window.location.href="formpost/processPOs.php?ids="+ids.join();
            }else{
        ...
        //not in use           
        function viewPO(fileName){
        //            alert(fileName);
        }
        function reloadpage(){
        var dtrng = $("#selDate").text();
        var url = "ajax/tb_unprocessed_po.php?selDateRange="+dtrng;    
        //     alert(url); 
    ...
    public function pageContent() {
        ...
        if($formResult->status == 'success'){ 
            ...
            echo 'alert("Selected POs are in process.")';
            echo '</script>';
        }            
        ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <h7><b>&nbsp;&nbsp;&nbsp;&nbsp;Unprocessed POs List </b></h7>
                        <div class="common-content-block">                     
                            <table id="tb_po" class="table table-striped table-bordered dt-responsive nowrap" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="5" align="center" class="dataTables_empty">Loading data from server</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
