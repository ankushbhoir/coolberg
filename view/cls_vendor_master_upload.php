...
class cls_vendor_master_upload extends cls_renderer {
...
/*            @import "https://cdn.datatables.net/1.10.15/css/dataTables.bootstrap.min.css";
        ...
        <script type="text/javaScript">  
            function downloadfile(){ 
                window.location.href="samplefiles/sample_vendor_master_upload1.csv";
            } 
        </script>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h2 class="title-bar">Upload Vendor Master File</h2>
                            <div class="common-content-block"> 
                                <div class="box box-primary"><br>
                                    <div class="box-body">
                                            
                                         <form action="formpost/upload_vendor_master.php" id="upload_vendor_master" name="upload_vendor_master" method="post" enctype="multipart/form-data">
                                            <input type = "hidden" name="form_id" id="form_id" value="upload_vendor_master">
                                            <div class="box-body">
